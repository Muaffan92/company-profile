<div class="mt-5 pt-4 d-flex align-items-center">
    ...
    <div class="ms-auto bg-white shadow me-5 rounded-3">
        <a href="<?= base_url('Camp/add_jenis') ?>" class="btn badge text-success fw-bold">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Camp/edit_jenis/' . $Jenis['id']) ?>" class="btn badge bg-warning rounded-pill">Edit</a>
                                <a href="<?= base_url('Camp/delete_jenis/' . $Jenis['id']) ?>" class="btn badge bg-danger rounded-pill">Hapus</a>
                            </td>
                        </tr>
                <?php
                    }
