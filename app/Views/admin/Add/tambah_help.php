<div class="mt-5 pt-4 d-flex align-items-center">
    <a href="<?= base_url('Camp/help') ?>" class="btn ms-3">
...
<div class="mt-4 bg-white p-4 text-dark">
    ...
    <form action="<?= base_url('Camp/insert_help') ?>" method="POST" class="needs-validation" novalidate>
        <div class="form-group">
            <label for="help" class="form-label">Help</label>
            <input type="text" class="form-control" id="help" name="help" placeholder="Masukan pertanyaan" required>
